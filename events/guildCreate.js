...
module.exports = async (client, guild) => {
	...
	const addGuildSettings = 'INSERT INTO `guildsettings` (`guildID`, `prefix`, `maxFamilySize`, `allowIncest`) VALUES (?, ?, ?, ?) ON DUPLICATE KEY UPDATE `prefix`= VALUES (`prefix`), `allowIncest`= VALUES (`allowIncest`)';
